...
from mmseg.utils import PatchEmbed
...
class VisionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        self.proj = nn.Parameter(scale * torch.randn(embed_dims, 512)) # need to change
        self.transformer = Transformer(embed_dims, num_layers, num_heads)
